(function(root, factory) {
  ...
  function Compiler(options) {
    ...
    this.keepWhitespace = options ? options.keepWhitespace === true : false;

    var escapeIdentifier = options && options.defaultEscape !== undefined
                          ? options.defaultEscape : 'escapeHtml';
