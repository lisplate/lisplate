(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    define('lisplate.compiler', ['lisplate.parser'], factory);
    ...
    root.lisplateCompiler = factory(root.lisplateParser);
  }
  ...
  function compile(templateName, src) {
    try {
      ...
      var code = 'function($$Lisplate,$$vmc){return function($data,$strings,$runtime) {var $viewmodel=$$vmc?new $$vmc($data):null; var $helper=$$Lisplate.helpers; var $_w=$runtime.$W;\nvar $c = new $_w();\n' + internals + compiled + '\nreturn $c.getOutput();\n}\n}';
      return code;
    } catch (err) {
      if (!err.location) {
        throw err;
