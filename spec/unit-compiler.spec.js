(function(root, factory) {
  if (typeof exports === 'object') {
    module.exports = factory(require('../lib/'), require('../lib/parser'), require('../lib/compiler'));
  } else {
    factory(root.Lisplate, root.Lisplate.Parser, root.Lisplate.Compiler);
  }
}(this, function(Lisplate, parser, compiler) {
  'use strict';
